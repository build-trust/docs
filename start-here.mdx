...
Within the `hello` directory, `ockam` has created the following files:
...
2. The main function start an agent on that node with specific instructions ("You are Jack Sparrow").
