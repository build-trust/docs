...
<Steps>
  ...
  <Step title="Deploy your first agent">
    ...
    Finally, the above command will download the code for a template `hello` app and create a production-ready deployment zone on our serverless runtime. Withing seconds, it will put your first AI Agent into production and you can immediately start interacting with it.
