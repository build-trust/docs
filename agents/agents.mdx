...
```[expandable]
» ockam
    Deploying zone 001 in cluster 25df35de87aa441b88f22a6c2a830a17...

  ✔ Created a repository for the image main
  ✔ Built image main
  ✔ Pushed image main

  ✔ Deployed zone 001 in cluster 25df35de87aa441b88f22a6c2a830a17

    The http server on the main-pod is available at:
    https://25df35de87aa441b88f22a6c2a830a17-001.ai.ockam.network
...
```bash httpie
http GET \
"https://25df35de87aa441b88f22a6c2a830a17-001.ai.ockam.network/agents"
```
...
```bash httpie
http POST \
"https://25df35de87aa441b88f22a6c2a830a17-001.ai.ockam.network/agents/henry" \
message="who are you"
```
...
```bash httpie
http POST \
"https://25df35de87aa441b88f22a6c2a830a17-001.ai.ockam.network/agents/henry?stream=true" \
